...
<div id="destinataire">
	Messages du user <?= htmlspecialchars($context->user->id) ?> : <?php echo htmlspecialchars($context->user->nom)." "; echo htmlspecialchars($context->user->prenom)." "; echo htmlspecialchars($context->user->identifiant)." "; echo htmlspecialchars($context->user->date_de_naissance->format('d-m-y'));?>
</div>
<div id="messages">
